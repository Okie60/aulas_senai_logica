...
namespace uauLegal//recomendado usar o nome do projeto
{
    class MainClass
    {
        ...
        static List<int> cpf = new List<int>();
        ...
        private static void Cadastrar()
        {
            ...
            WriteLine("Digite a cidade de residência:");
            cidade.Add(ReadLine());
            WriteLine("Digite o CPF:");
            cpf.Add(Convert.ToInt32(ReadLine()));//mesma coisa com números
            WriteLine();
        }
        ...
        private static void Editar()
        {
            ...
            {
                WriteLine("Registro");
                WriteLine($"Nome: {nomes[index]} - Cidade: {cidade[index]} - CPF: {cpf[index]}");
                ...
                WriteLine("\nDigite o novo CPF:");
                cpf[index] = Convert.ToInt32(ReadLine());
            }
            else
            {
        ...
        private static void Listar()
        {
            ...
            {
                WriteLine($"Nome: {item} - Cidade: {cidade[pos]} - CPF: {cpf[pos]}");
                pos++;
            }
        }
    }
